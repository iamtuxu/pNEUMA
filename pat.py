...
# for tracked_vehicle_id in range(1, 12):
    ...
    #     ### calculate Lane number
        ...
        if float(new_trajectory['lon'][row]) > 0.251859468727949 * float(new_trajectory['lat'][row]) + 14.16265163049736:
            lane = 1
        elif float(new_trajectory['lon'][row]) > 0.2461525278535547 * float(new_trajectory['lat'][row]) + 14.379431095806604:
            lane = 2
        else:
            lane = 3
        # if row % 100 == 0:
        #     print(new_trajectory['lon'][row])
        #     print(0.253378 * float(new_trajectory['lat'][row]) + 14.1049)
        #     print(0.246153 * float(new_trajectory['lat'][row]) + 14.3794)
        #     print(lane)
